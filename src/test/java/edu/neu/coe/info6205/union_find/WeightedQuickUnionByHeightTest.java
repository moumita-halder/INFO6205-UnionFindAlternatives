...
public class WeightedQuickUnionByHeightTest {
    ...
    public void testToString() {
        Connections h = new WeightedQuickUnionByHeight(2);
        assertEquals("WeightedQuickUnionByHeight:\n" +
                "  count: 2\n" +
    ...
    public void testIsConnected02() {
        Connections h = new WeightedQuickUnionByHeight(1);
    ...
    public void testFind0() {
        UF h = new WeightedQuickUnionByHeight(1);
    ...
    public void testFind1() {
        UF h = new WeightedQuickUnionByHeight(2);
        h.connect(0, 1);
        assertEquals(0, h.find(0));
    ...
    public void testFind2() {
        UF h = new WeightedQuickUnionByHeight(3, false);
        h.connect(0, 1);
        assertEquals(0, h.find(0));
        assertEquals(0, h.find(1));
        h.connect(2, 1);
    ...
    public void testFind3() {
        UF h = new WeightedQuickUnionByHeight(6, false);
        h.connect(0, 1);
        h.connect(0, 2);
        h.connect(3, 4);
        h.connect(3, 5);
    ...
    public void testFind4() {
        UF h = new WeightedQuickUnionByHeight(6);
        h.connect(0, 1);
        h.connect(0, 2);
        h.connect(3, 4);
        h.connect(3, 5);
    ...
    public void testConnected01() {
        Connections h = new WeightedQuickUnionByHeight(10);
//        h.show();
        assertFalse(h.isConnected(0, 1));
    }
}